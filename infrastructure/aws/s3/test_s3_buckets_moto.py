...
class TestS3WithFixtures:
    ...
    @mock_aws
    def test_simple_workflow_with_fixtures(self, s3_service, test_bucket, test_file, test_content):
    ...
    @mock_aws
    def test_multiple_files_same_bucket(self, s3_service, test_bucket):
    ...
    @mock_aws
    def test_with_pre_populated_bucket(self, s3_service, pre_populated_bucket, test_file, test_content):
